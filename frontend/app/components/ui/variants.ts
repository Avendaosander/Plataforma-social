const solid = {
  primary: `bg-seagreen-900 text-white dark:bg-storm-900`,
  secondary: `bg-biscay-950 text-white `,
  destructive: `bg-maroon-900 text-white`,
}
...
const ghost = {
  ...
  secondary: `text-biscay-950`,
  destructive: `text-maroon-900`,
}
